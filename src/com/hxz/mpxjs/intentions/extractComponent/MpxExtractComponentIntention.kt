...
class MpxExtractComponentIntention : JavaScriptIntention() {
  override fun getFamilyName(): String {
    return MpxBundle.message("mpx.template.intention.extract.component.family.name")
  }

  override fun getText(): String {
    return MpxBundle.message("mpx.template.intention.extract.component")
  }

  override fun isAvailable(project: Project, editor: Editor?, element: PsiElement): Boolean {
    editor ?: return false
    if (MpxFileType.INSTANCE != element.containingFile?.fileType) return false
