...
class MpxFileElementType : IStubFileElementType<PsiFileStub<HtmlFileImpl>>(MpxLanguage.INSTANCE) {
  companion object {
    @JvmStatic
    val INSTANCE: MpxFileElementType = MpxFileElementType()
  ...
  override fun getStubVersion(): Int {
    return HtmlFileElementType.getHtmlStubVersion() + MpxStubElementTypes.VERSION
  }
  ...
  override fun doParseContents(chameleon: ASTNode, psi: PsiElement): ASTNode {
    ...
    if (delimiters != null
        && languageForParser === MpxLanguage.INSTANCE) {
      val project = psi.project
      val builder = PsiBuilderFactory.getInstance().createBuilder(
        project, chameleon, MpxParserDefinition.createLexer(project, delimiters), languageForParser, chameleon.chars)
